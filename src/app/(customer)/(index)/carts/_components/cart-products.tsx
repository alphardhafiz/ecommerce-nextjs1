...
export default function CartProdcuts() {
        ...
        >
          ...
          <div className="w-[120px] flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3">
              <button type='button' className="w-6 h-6 flex shrink-0" onClick={() => decreaseQuantity(cart.id)}>
                <img src="/assets/icons/minus-cirlce.svg" alt="minus" />
              </button>
              <p className="text-[#0D5CD7] font-semibold leading-[22px]">
                {cart.quantity}
              </p>
              <button type='button' className="w-6 h-6 flex shrink-0" onClick={() => increaseQuantity(cart.id)}>
